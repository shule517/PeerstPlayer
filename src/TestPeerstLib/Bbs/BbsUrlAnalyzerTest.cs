...
namespace TestPeerstLib.Bbs
{
	...
	public class BbsUrlAnalyzerTest
	{
		...
		public void BbsUrlAnalyzer_Analyze()
		{
			...
			// わいわいKakiko
			CheckBbsInfo("http://yy25.60.kg/test/read.cgi/peercastjikkyou/1368534792/",
				new BbsInfo
				{
					Url = "http://yy25.60.kg/test/read.cgi/peercastjikkyou/1368534792/",
					BoardGenre = "yy25.60.kg",
					BoardNo = "peercastjikkyou",
					ThreadNo = "1368534792",
			...
			CheckBbsInfo("http://yy25.60.kg/test/read.cgi/peercastjikkyou/",
				new BbsInfo
				{
					Url = "http://yy25.60.kg/test/read.cgi/peercastjikkyou/",
					BoardGenre = "yy25.60.kg",
					BoardNo = "peercastjikkyou",
					ThreadNo = null,
					BbsServer = BbsServer.YYKakiko,
			...
			CheckBbsInfo("http://yy25.60.kg/peercastjikkyou/1368534792/",
				new BbsInfo
				{
					Url = "http://yy25.60.kg/peercastjikkyou/1368534792/",
					BoardGenre = "yy25.60.kg",
					BoardNo = "peercastjikkyou",
					ThreadNo = "1368534792",
					BbsServer = BbsServer.YYKakiko,
			...
			*/
			CheckBbsInfo("http://yy25.60.kg/peercastjikkyou/",
				new BbsInfo
				{
					Url = "http://yy25.60.kg/peercastjikkyou/",
					BoardGenre = "yy25.60.kg",
					BoardNo = "peercastjikkyou",
					ThreadNo = null,
					BbsServer = BbsServer.YYKakiko,
